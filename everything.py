# all in one place, for training
from categorizer import categorize

categorize(
    "/content/drive/My Drive/Amazon Review Data/Office_Products_5.json.gz", prefix='office')
categorize(
    '/content/drive/My Drive/Amazon Review Data/Books_5.json.gz', prefix='books')
categorize('/content/drive/My Drive/Amazon Review Data/Cell_Phones_and_Accessories_5.json.gz',
           prefix='cell_phone')
categorize('/content/drive/My Drive/Amazon Review Data/Clothing_Shoes_and_Jewelry_5.json.gz',
           prefix='clothing_shoe_jewellery')
categorize('/content/drive/My Drive/Amazon Review Data/Electronics_5.json.gz',
           prefix='Electronics')
categorize(
    '/content/drive/My Drive/Amazon Review Data/Kindle_Store_5.json.gz', prefix='Kindle')
categorize(
    '/content/drive/My Drive/Amazon Review Data/Movies_and_TV_5.json.gz', prefix='Movies')
categorize(
    '/content/drive/My Drive/Amazon Review Data/Sports_and_Outdoors_5.json.gz', prefix='Sports')
...
train_features, test_features, Y_train, Y_test = vectorize_data(
    vectorizer_path, train_data, test_data)
